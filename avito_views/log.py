...
телом страницы. Тело держим ровно последнее на воркера: оно нужно, когда задача сломалась
окончательно и хочется увидеть, что же пришло.
"""
...
class Наблюдатель:
    ...
    def дамп(self, метка: str) -> Path | None:
        ...
        self.лог.info("страница сохранена: %s", куда)
        return куда
